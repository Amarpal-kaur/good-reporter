...
internals.GoodReporter.prototype.report = function (event, eventData) {

    throw new Error('Instance of GoodReporter must implement their own "report" function.');
};


internals.GoodReporter.prototype.handleEvent = function (event, eventData) {

    if (this._filter.apply(this, arguments)) {
        this.report.apply(this, arguments);
    }
};


internals.GoodReporter.prototype._register = function (emitter, events) {
